...
- [Сети, безопасность и протоколы](#Сети,-безопасность-и-протоколы) — Протоколы транспорта, сертификаты, шифрование и модели сетевого взаимодействия.
...
- [CI/CD](#CI/CD) — Gitlab CI, Jenkins, Github Actions, Circle CI, Travis CI, Bamboo, Teamcity, Azure DevOps.
