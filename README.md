...
- Система контроля версий
  - [Git :ru:](https://git-scm.com/book/ru/v2/Введение-Что-такое-Git%3F) — что такое Git?
  - [Git How To :ru:](https://githowto.com/ru) — интерактивный тур, который познакомит с основами Git
