...
Dockerfile позволяет создавать одинаковое окружение для работы программы, независимо от машины, которая собирает образ. Прочитайте обзорную статью о Docker<!--TODO: Ссылка на статью про Docker-->, чтобы лучше разобраться, зачем это нужно.
...
Например, установим платформу Node.js<!--TODO: Ссылка на обзорную статью о Node.js--> поверх образа с чистой Ubuntu:
